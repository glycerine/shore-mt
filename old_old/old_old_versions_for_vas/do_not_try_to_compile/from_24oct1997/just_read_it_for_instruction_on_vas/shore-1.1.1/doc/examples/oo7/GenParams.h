/*$Header: /p/shore/shore_cvs/src/oo7/GenParams.h,v 1.2 1994/02/04 19:20:18 nhall Exp $*/
/********************************************************/
/*                                                      */
/*               OO7 Benchmark                          */
/*                                                      */
...
#define DocumentText "I am the documentation for composite part #%08d.\n"
    const int DocTextLength    = 80;	// must be as long as the expanded
					// DocumentText

#define ManualText "I am the manual for module #%08d.\n"
    const int ManualTextLength    = 80;	// must be as long as the expanded
					// ManualText
    const int BytesPerCompositePart = 15000;
