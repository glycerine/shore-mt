...
t_test_int_btree(Tcl_Interp* ip, int ac, char* av[])
{
    ...
    int e;
    e= _t_test_typed_btree(ip, vid, lstid, n, "i4", 0);
...
t_test_typed_btree(Tcl_Interp* ip, int ac, char* av[])
{
    ...
    return _t_test_typed_btree(ip, vid, lstid, n, av[3], av[4]);
}
...
typed_btree_test 
get_key_type( Tcl_Interp *ip, const char *stidstring )
{
