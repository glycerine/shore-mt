...
/* --------------------------------------------------------------- */
#if (__GNUC_MINOR__ < 7)
static char *rcsid="$Header: /p/shore/shore_cvs/src/examples/stree/ix_main.C,v 1.8 1996/07/19 22:57:14 nhall Exp $";
...
Ref<DocIndex> repository;
Ref<Pool> nodes;		// Place to create new anonymous objects

const char *DEMO_DIR = "doc_index";
...
enum OPERATION {
	OP_NONE, OP_ADD, OP_LIST, OP_DEL, OP_POOL_LIST
} operation = OP_NONE;
