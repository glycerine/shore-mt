...
/*<std-header orig-src='shore'>
 ...
 $Id: btree_impl.cpp,v 1.54 2012/01/02 21:52:23 nhall Exp $
                ...
                if (!total_match && slot < leaf.nrecs())  {
                    ...
                    if (! leaf.next())  {
                        ...
                        if(sib.nrecs() > 0) {
                            ...
                            w_assert2(leaf.is_fixed());
                            if(rce) { 
                                // leaf destructor unfixes the page.
                                return RC(rce); 
                            }
                            DBGTHRD(<<"POSC done; ->again TREE LATCH MODE "
                                << int(tree_root.latch_mode())
     ...
     again:
        ...
        case m_not_found_end_of_non_empty_page: {
            ...
            if(whatcase == m_satisfying_key_found_same_page) {
                ...
                // destructors for leaf & p2 unfix them.
                goto again;
            }
            }break;
        ...
        case m_not_found_page_is_empty: {
            ...
            if(leaf.is_smo()) {
                ...
                tree_root.unfix();
                if(rce && (rce != eRETRY)) {
                    // leaf and parent destructors unfix them
                    return RC(rce);
                }
        ...
        for ( ; p[c].is_node(); c = 1 - c)  {
            ...
            if(wait_for_posc) {
                 ...
                 */
                {
                    ...
                    if(rce && (rce != eRETRY)) {
                        tree_root.unfix();
                        // p[i] destructors unfix the pages
                        return RC(rce);
                    }
