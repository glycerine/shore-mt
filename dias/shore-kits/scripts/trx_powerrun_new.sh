...
#@file:   scripts/trx_powerrun_new.sh 
#@brief:  For a specific xct it executes powerruns for a set of different clients
#@author: Ippokratis Pandis
#@author: Pinar Tozun

# args: <low> <high> <xctid> <time> <iter> <sleeptime> <clientset> <logtype> <sli> <elr>
usage()
{
    echo "Usage: $0 <low> <high> <xctid> <time> <iter> <sleeptime> <clientset> <logtype> <sli> <elr>" >&2
}
